...
class CommitFi(ARC4Contract):
    ...
    def create_challenge(
        ...
        self.creator = Txn.sender  # Set creator to transaction sender
        self.stake_amount = stake_amount_param  # Set required stake amount
        self.deadline = deadline_param  # Set challenge deadline
        self.max_participants = max_participants_param  # Set max participants
        self.current_participants = UInt64(0)  # Initialize participant count to 0
        self.total_pooled_stake = UInt64(0)  # Initialize total stake to 0
        self.challenge_status = UInt64(0)  # Set status to SETUP
